...
| China A-shares | Tencent, Twelve Data, yfinance, AkShare | Strategy paper trading + analysis/backtest only; no live broker execution |
...
| [CNStock Paper Trading UI](docs/FRONTEND_CN_STOCK_PAPER_TRADING.md) | Frontend integration notes for A-share strategy paper trading |
