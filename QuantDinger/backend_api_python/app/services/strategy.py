...
class StrategyService:
    ...
    def create_strategy(self, payload: Dict[str, Any]) -> int:
        ...
        execution_mode = (payload.get('execution_mode') or 'signal').strip().lower()
        ...
        if market_category == 'CNStock' and execution_mode == 'paper':
    ...
    def update_strategy(self, strategy_id: int, payload: Dict[str, Any], user_id: int = None) -> bool:
        ...
        execution_mode = (payload.get('execution_mode') or existing.get('execution_mode') or 'signal').strip().lower()
