...
const locale = {
  ...
  'trading-assistant.form.executionModePaper': '模拟盘交易',
  'trading-assistant.form.executionModePaperDesc': '只做模拟撮合，不会连接真实券商或发送真实订单。',
  ...
  'trading-assistant.paper.cnStockRuleHint': '仅模拟盘：只做多、{lotSize} 股一手、T+1 可卖、不连接真实券商。',
  'trading-assistant.paper.cnStockDetailTitle': 'A股模拟盘策略',
  'trading-assistant.paper.simulatedRecords': '模拟成交记录',
